...
import static hansanhha.querydsl.book.repository.v2.expression.BookCategoryExpression.BookCategoryBooleanExpressions.*;

@RequiredArgsConstructor
public class BookCategoryExpression implements BookSearchExpression {

    private final BookCategory category;

    @Override
    public BooleanExpression buildEqualExpression(QBook book) {
